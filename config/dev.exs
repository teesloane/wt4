...
config :weakty, WeaktyWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "UO9ujdxYN1ZOuKAHGBONglLKcMUjnLrP3hkU+czLRjbBoTu4Ue14s60s2zkgXjpX",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:weakty, ~w(--sourcemap=inline --watch)]},
...
config :weakty, WeaktyWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/weakty_web/router\.ex$",
      ~r"lib/weakty_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
